...
export const siteConfig: SiteConfig = {
  title: 'Cloudy Waters',
  subtitle: 'My thoughts thoughout my technical and professional life',
  ...
  favicon: [   {
    src: 'src/assets/images/favicon-32x32.png',    // Path of the favicon, relative to the /public directory
